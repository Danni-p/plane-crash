...
<div class="q-pa-xl col-lg-6 col-12">
  ...
  <q-carousel
      ...
      height="50vh"
    >
      <q-carousel-slide @click="gotoLeftWing()" class="row items-center" :name="1" img-src="fluegelLinks.jpeg">
      </q-carousel-slide>
      <q-carousel-slide @click="gotoCockpit()" class="row items-center" :name="2" img-src="cockpit.jpeg">
      </q-carousel-slide>
      <q-carousel-slide @click="gotoRightWing()" class="row items-center" :name="3" img-src="fluegelRechts.jpeg">
      </q-carousel-slide>
    </q-carousel>
</div>
